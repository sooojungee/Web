let blogCard = [
  {
    ...
    tag: ['fractal', 'canvas', 'rotate', 'color', 'lllsllslslslslslsls']
  },
  {
    text: 'textFinder',
    date: 'JULY 2018',
...
const blogEvent = new function () {
  ...
  this.addCard = (arr) => {
    ...
    // $('#' + id).parents('.col-md-4').removeClass('display-none');
    // $template.find('back-img').css('background', url(${arr.imgUrl}));
